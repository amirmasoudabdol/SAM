...
BOOST_FIXTURE_TEST_SUITE ( yuen_t_test, SampleResearch )
    ...
    BOOST_AUTO_TEST_CASE( yuen_one_sample )
    {
        ...
        // a <- rnorm(25, 3, 1)
        arma::Row<double> a = {3.290169, 3.031275, 2.701008, 3.703762, 4.633237, 2.327662, 3.050368,\
        2.634829, 3.358146, 3.350406, 2.490066, 3.500233, 5.485966, 3.566797, 1.945628, 2.878948,\
        2.920190, 3.402363, 2.821342, 3.640249, 4.717522, 3.353228, 2.334823, 1.997572, 2.817784};
    ...
    BOOST_AUTO_TEST_CASE( yuen_two_samples )
    {
        ...
        // a <- rnorm(25, 3, 1)
        arma::Row<double> a = {3.290169, 3.031275, 2.701008, 3.703762, 4.633237, 2.327662, 3.050368, 2.634829, 3.358146, 3.350406, 2.490066, 3.500233, 5.485966, 3.566797, 1.945628, 2.878948, 2.920190, 3.402363, 2.821342, 3.640249, 4.717522, 3.353228, 2.334823, 1.997572, 2.817784};

        // b <- rnorm(23, 2, 1)
        arma::Row<double> b = {1.8461070, 1.7434951, 2.5623408, 1.2993293, 1.7287880, 1.1736090, 2.8343341, 1.0222412, 2.3009044, 1.6807970, 1.9258431, 2.3732799, 1.0147146, 1.6255013, 1.9335160, 3.2866492, 4.4683571, 2.8719037, 1.8299214, 1.5066573, 1.4453529, 0.4761787, 3.2652345};
