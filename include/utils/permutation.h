...
//
//
//  Source: https://howardhinnant.github.io/combinations.html
...
public:
    ...
    bool operator()(It first, It last)  // called for each permutation
    {
        ...
        permutations.push_back(std::vector<int>(first, last));
        
        return false;
    }

    // Returning the visited permutation
    operator std::vector<std::vector<int>>() const {return permutations;}
};
