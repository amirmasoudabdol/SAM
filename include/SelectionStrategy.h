...
/**
 ...
 decision can be made based on different criteria or formula. A
 ...
 *p*-value is significant. Certain degree of *publication bias*, can be
 specified. In this case, a Submission has a chance of being published even if
 the statistics is not significant. Moreover, the SignificantSelection can be
 tailored toward either positive or negative effect. In this case, the Journal
 will only accept Submissions with larger or smaller effects.
 */
...
/**
 ...
 In this method, Journal does not check any criteria for accepting or rejecting
 a submission. Each submission has 50% chance of being accepted or not.
...
/**
 @brief FreeSelection doesn't pose any restriction on the submission and all
