...
//    3.198143
    ...
    double r_p_value = 2.926e-12;
    
    TestResult res = t_test(0., 0., 0., mean(a), stddev(a), a.size(), 0.05, TestSide::TwoSide);
...
//    3.198143  2.009350
    ...
    TestResult res = t_test(mean(a), 1, a.size(), mean(b), 1, b.size(), 0.05, TestSide::TwoSide);
