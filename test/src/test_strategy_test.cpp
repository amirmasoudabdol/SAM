...
//    3.198143  2.009350
    ...
    // a <- rnorm(25, 3, 1)
    Row<double> a = {3.290169, 3.031275, 2.701008, 3.703762, 4.633237, 2.327662, 3.050368, 2.634829, 3.358146, 3.350406, 2.490066, 3.500233, 5.485966, 3.566797, 1.945628, 2.878948, 2.920190, 3.402363, 2.821342, 3.640249, 4.717522, 3.353228, 2.334823};
    ...
    TestResult res = t_test(mean(a), stddev(a), a.size(), mean(b), stddev(b), b.size(), 0.05, TestSide::TwoSide, true);
